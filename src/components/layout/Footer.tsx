      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-primary-foreground/80">Your Home Away From Home</p>
              </div>
            </div>
            <p className="text-primary-foreground/80 mb-6 max-w-md">
              Nestled in the heart of nature, Pine Ridge RV Resort offers premium camping experiences 
              with modern amenities and breathtaking mountain views. Create memories that last a lifetime.
            </p>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/rates" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                Rates & Pricing
              </Link>
              <Link to="/reservations" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                Reservations
              </Link>
              <Link to="/about/rules" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                Park Rules
              </Link>
            </nav>
          </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">123 Forest Trail<br />Mountain View, CA 94041</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            ...
            <Link to="/rates/cancellation" className="text-primary-foreground/60 hover:text-primary-foreground transition-colors">
              Cancellation Policy
            </Link>
          </div>
        </div>
