  ...
  const featuredActivities = [
    {
      ...
      description:
        "Families enjoying our heated swimming pool with mountain backdrop",
    ...
    },
    {
      ...
      description:
        "Evening gathering around the central fire pit with s'mores and stories",
    ...
    },
    {
      ...
      description:
        "Guests exploring the scenic Pine Ridge Nature Trail with guided tour",
    ...
    },
    {
      ...
      description:
        "Children enjoying our modern playground equipment in safe environment",
    ...
    },
    {
      ...
      description:
        "Anglers showing off their catch from our well-stocked fishing lake",
      category: "Water Activities",
    ...
    },
    {
      ...
      description:
        "Families competing in ping pong and arcade games in the recreation center",
      category: "Family Activities",
      season: "All Year",
      ageGroup: "All Ages",
      time: "Any Time",
    ...
    },
    {
      ...
      description:
        "Guests unwinding in the hot tub as the sun sets over the mountains",
      category: "Water Activities",
      season: "All Year",
      ageGroup: "Adults",
      time: "Evening",
    ...
    },
    {
      ...
      description:
        "Local musicians performing at our outdoor amphitheater under the stars",
      category: "Evening Entertainment",
      season: "Summer",
      ageGroup: "All Ages",
      time: "Evening",
    ...
    },
    {
      ...
      description:
        "Friendly competition on our well-maintained basketball court",
      category: "Family Activities",
      season: "All Year",
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>6:00 AM - 10:00 PM:</strong> Swimming Pool &
                          Hot Tub
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Sunrise/Sunset:</strong> Best fishing times
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>8:00 AM - 6:00 PM:</strong> Playground active
                          hours
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Dawn to Dusk:</strong> Nature trails open
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Saturday 7:30 PM:</strong> Campfire stories &
                          s'mores
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Summer Evenings:</strong> Live music
                          performances
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Weekends:</strong> Organized family activities
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Monthly:</strong> Special themed events
                        </span>
                      </li>
                    </ul>
                  </div>
      ...
      <section className="py-20 bg-warm-gradient text-orange-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-orange-foreground/90 max-w-2xl mx-auto">
            Book your stay and create your own amazing activity memories at Pine
            Ridge.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="hero" size="lg" asChild>
              <Link href="/reservations">Book Your Adventure</Link>
            </Button>
            <Button
              variant="outline"
              size="lg"
