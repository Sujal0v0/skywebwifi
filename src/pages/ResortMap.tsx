  ...
  const mapAreas = [
    {
      ...
      zone: 'Zone A',
      description: 'Premium sites with direct lake access and stunning water views',
      sites: '1-25',
      features: ['Lake Views', 'Premium Hookups', 'Extended Patios', 'Private Access'],
      icon: Waves,
    ...
    },
    {
      ...
      sites: '76-125',
      features: ['Mountain Views', 'Full Hookups', 'Level Sites', 'Sunrise Views'],
      icon: Home,
      color: 'bg-orange/10'
    },
    {
      ...
      sites: '126-175',
      features: ['No Backing Required', '50 Amp Service', 'Wide Sites', 'Concrete Pads'],
      icon: Car,
      color: 'bg-primary/10'
    },
    {
      ...
      sites: '176-200',
      features: ['Group Sites', 'Pavilion Access', 'Extra Space', 'Group Activities'],
      icon: Building,
      color: 'bg-accent/10'
    }
  ];
  ...
  const facilities = [
    {
      ...
      services: ['Check-in/out', 'Information', 'Reservations', 'Emergency Contact']
    },
    {
    ...
    },
    {
      ...
      services: ['Playground', 'Basketball Court', 'Volleyball Court', 'Horseshoe Pits']
    }
  ];
  ...
  const trails = [
    {
      ...
      difficulty: 'Easy',
      distance: '1.2 miles',
      description: 'Scenic walk along the lake with wildlife viewing opportunities',
    ...
    },
    {
      ...
      features: ['Forest Views', 'Educational Signs', 'Picnic Areas', 'Photo Opportunities']
    },
    {
      ...
      features: ['Mountain Views', 'Summit Overlook', 'Challenging Terrain', 'Scenic Vistas']
    }
  ];
      ...
      <section className="py-20 bg-hero-gradient text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Resort Map & Layout</h1>
            <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8">
              Navigate our 300-acre resort with detailed maps and facility information
            </p>
                ...
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <CardDescription>Sites {area.sites} • {area.description}</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="border-primary/20">
              <CardHeader>
                <CardTitle className="text-2xl text-center">Map Information & Legend</CardTitle>
              </CardHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>Emergency phones located throughout the resort</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>Bicycle-friendly paths throughout the resort</span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>GPS coordinates provided for easy navigation</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>Staff available for directions and assistance</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>Detailed facility hours posted at each location</span>
                      </li>
                    </ul>
                  </div>
                </div>
      ...
      <section className="py-20 bg-warm-gradient text-orange-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-orange-foreground/90 max-w-2xl mx-auto">
            Use our resort map to choose your ideal site and plan your activities.
          </p>
