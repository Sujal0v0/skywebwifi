...
const Accommodations = () => {
  const siteTypes = [
    {
      ...
      price: 'From $45/night',
      features: ['30/50 Amp Electric', 'Water & Sewer', 'Picnic Table', 'Fire Ring', 'WiFi Access'],
      icon: Home,
      color: 'bg-primary/10',
    ...
    },
    {
      ...
      price: 'From $55/night',
      features: ['30/50 Amp Electric', 'Water & Sewer', 'Lake Views', 'Extended Patio', 'Premium WiFi', 'Reserved Parking'],
      icon: Mountain,
      color: 'bg-orange/10',
    ...
    },
    {
      ...
      price: 'From $50/night',
      features: ['50 Amp Electric', 'Water & Sewer', 'Easy Access', 'No Backing Required', 'Extra Wide', 'Concrete Pad'],
      icon: Car,
      color: 'bg-accent/10',
      maxOccupancy: '6 guests',
    ...
    },
    {
      ...
      price: 'From $25/night',
      features: ['Electric Hook-up', 'Water Access', 'Picnic Table', 'Fire Ring', 'Restroom Access', 'Shower Facilities'],
      icon: Tent,
  ...
  const amenities = [
    { name: 'High-Speed WiFi', icon: Wifi, description: 'Complimentary internet throughout the resort' },
    { name: 'Full Electrical', icon: Zap, description: '30 & 50 amp electrical connections available' },
    { name: 'Water & Sewer', icon: Droplets, description: 'Full hookups at every RV site' },
    { name: 'Cable TV Ready', icon: Tv, description: 'Cable connections available at premium sites' },
    { name: 'Landscaped Sites', icon: TreePine, description: 'Beautifully maintained natural landscaping' },
    { name: 'Group Areas', icon: Users, description: 'Special group camping areas for large parties' }
  ];
              ...
              <Card key={index} className="border-border hover:shadow-soft transition-shadow">
                <CardHeader>
                  <div className="flex items-center gap-4 mb-2">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${site.color}`}>
                      <site.icon className="h-6 w-6 text-primary" />
                    </div>
                    <div className="flex-1">
                      <CardTitle className="text-xl">{site.title}</CardTitle>
                      <div className="text-2xl font-bold text-orange">{site.price}</div>
                    </div>
                  </div>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Site Size</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Thoughtfully designed for comfort, convenience, and natural beauty
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <h3 className="text-2xl font-bold text-foreground mb-4">Spacious & Private</h3>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Our sites are designed with ample space and natural privacy screening using mature trees 
                    and landscaping. Each site provides plenty of room for your RV, vehicles, and outdoor activities.
                  </p>
                  <p>
                    Premium sites offer even more space with extended patios, perfect for families or groups 
                    who want extra room to spread out and enjoy the outdoors.
                  </p>
                </div>
              </div>
              <div className="space-y-4">
                <Card className="border-l-4 border-l-primary">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      All sites are level and easily accessible, with paved roads and clear site markers.
                    </p>
                  </CardContent>
                </Card>
                <Card className="border-l-4 border-l-orange">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Surrounded by mature pine trees with mountain and lake views from select sites.
                    </p>
                  </CardContent>
                </Card>
                <Card className="border-l-4 border-l-accent">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Reliable utilities, high-speed internet, and well-maintained facilities throughout.
                    </p>
                  </CardContent>
                </Card>
              </div>
