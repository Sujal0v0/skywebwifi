...
const Rates = () => {
  const baseRates = [
    {
      ...
      includes: ['Full hookups', 'WiFi access', 'Amenity access', 'Picnic table & fire ring']
    },
    {
      type: 'Weekly Rate',
      standard: '$280',
      ...
      includes: ['All daily inclusions', '10% discount', 'Late checkout available', 'Complimentary firewood']
    },
    {
      type: 'Monthly Rate',
      standard: '$1,000',
      ...
      includes: ['All weekly inclusions', '25% discount', 'Reserved parking', 'Priority booking for next month']
    }
  ];
  ...
  const extraFees = [
    { item: 'Additional Guests (over 4)', fee: '$5/night per person', icon: Users },
      ...
      <section className="py-20 bg-hero-gradient text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Rates & Pricing</h1>
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm">
              ...
              <span>Multiple discounts available • Book direct for best rates</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
                ...
                <CardContent className="space-y-6">
                  <div className="text-center space-y-2">
                    <div className="space-y-1">
                      <p className="text-sm text-muted-foreground">Standard Sites</p>
                      <p className="text-3xl font-bold text-primary">{rate.standard}</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm text-muted-foreground">Premium Sites</p>
                      <p className="text-2xl font-semibold text-orange">{rate.premium}</p>
                    </div>
                  </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-muted-foreground mb-4">
              Premium sites feature lake views, extra space, and enhanced privacy
            </p>
      ...
      <section className="py-20 bg-subtle-gradient">
        <div className="container mx-auto px-4">
            ...
            {seasonalRates.map((season, index) => (
              <Card key={index} className={`border-2 ${season.color}`}>
                <CardContent className="p-6 text-center">
                  <h3 className="text-xl font-bold text-foreground mb-2">{season.season}</h3>
                  <p className="text-lg font-semibold text-primary mb-2">{season.months}</p>
                  <div className="text-2xl font-bold text-orange mb-3">{season.multiplier}</div>
          ...
          <div className="mt-12 text-center bg-muted/50 p-6 rounded-lg max-w-4xl mx-auto">
            <h3 className="text-lg font-semibold mb-2">Seasonal Rate Example</h3>
            <p className="text-muted-foreground">
              Peak season daily rate: $45 (standard) | High season: $38 | Low season: $32
            </p>
          </div>
        </div>
      </section>
            ...
            {extraFees.map((fee, index) => (
              <Card key={index} className="border-border hover:shadow-soft transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-foreground mb-2">{fee.item}</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {promotions.map((promo, index) => (
              <Card key={index} className={`border-border hover:shadow-soft transition-shadow ${promo.color}`}>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="inline-flex items-center gap-2 bg-primary/10 px-3 py-1 rounded-full">
                        <span className="text-xs font-medium text-primary">Code: {promo.code}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="border-primary/20">
              <CardHeader>
                <CardTitle className="text-xl">Important Pricing Information</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 text-sm text-muted-foreground">
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>All rates are per night and include up to 4 guests per site</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>Rates subject to availability and may change during special events</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>Discounts cannot be combined unless otherwise specified</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>Holiday and special event rates may apply (Memorial Day, 4th of July, Labor Day)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>California state taxes and local fees additional where applicable</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-warm-gradient text-orange-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-orange-foreground/90 max-w-2xl mx-auto">
            Reserve your site today and take advantage of our competitive rates and special offers.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" className="bg-white/10 border-white/30 text-white hover:bg-white/20" asChild>
              <Link to="/rates/cancellation">Cancellation Policy</Link>
            </Button>
          </div>
        </div>
      </section>
