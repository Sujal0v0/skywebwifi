  ...
  const currentOffers = [
    {
      ...
      terms: ['Valid for stays April 1 - May 31', 'Must book by March 31', 'Minimum 3-night stay'],
      category: 'Seasonal'
    },
    {
      ...
      icon: Calendar,
      color: 'bg-primary/10',
      terms: ['14+ night minimum stay', 'Cannot combine with other offers', 'Valid on standard sites'],
      category: 'Long Stay'
    },
    {
      ...
      icon: Star,
      color: 'bg-orange/10',
      terms: ['Valid ID required', 'Active or retired service', 'Year-round availability'],
      category: 'Military'
    },
    {
      ...
      icon: Heart,
      color: 'bg-accent/10',
      terms: ['65+ years of age', 'Valid ID required at check-in', 'All site types eligible'],
      category: 'Senior'
    }
  ];
  ...
  const specialPackages = [
    {
      ...
      includes: ['Premium lakeside site', 'Champagne & chocolates', 'Late checkout', 'Candlelit dinner'],
      icon: Heart,
    ...
    },
    {
      ...
      includes: ['Family-friendly site', 'Activity passes', 'Playground access', 'S\'mores kit'],
      icon: Users,
    ...
    },
    {
      ...
      includes: ['Trail maps', 'Hiking gear rental', 'Guided nature walk', 'Adventure checklist'],
      icon: Trophy,
      color: 'bg-green-500/10'
    }
  ];
    ...
    tiers: [
      {
        name: 'Explorer',
        nights: '1-9 nights',
        benefits: ['10% discount on extended stays', 'Early check-in when available', 'Birthday discount'],
        color: 'text-blue-600'
      },
      {
        name: 'Adventurer',
        nights: '10-24 nights',
        benefits: ['15% discount on future stays', 'Site upgrade priority', 'Late checkout', 'Exclusive offers'],
        color: 'text-orange-600'
      },
      {
        name: 'Champion',
        nights: '25+ nights',
        benefits: ['20% discount on all stays', 'Best site guarantee', 'VIP treatment', 'Referral bonuses'],
      ...
      <section className="py-20 bg-hero-gradient text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Special Offers & Discounts</h1>
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm">
              ...
              <span>Year-Round Savings • Exclusive Packages • Loyalty Rewards</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {currentOffers.map((offer, index) => (
              <Card key={index} className={`border-border hover:shadow-soft transition-shadow ${offer.color}`}>
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-sm">Code: {offer.code}</span>
                    </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {specialPackages.map((package_, index) => (
              <Card key={index} className={`border-border text-center ${package_.color}`}>
                <CardHeader>
                  <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <package_.icon className="h-8 w-8 text-primary" />
                  </div>
                  <CardTitle className="text-xl">{package_.title}</CardTitle>
                  <div className="text-2xl font-bold text-orange">{package_.price}</div>
            ...
            <Card className="border-primary/20 text-center">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Loyalty tiers are based on total nights stayed with us. Benefits apply immediately upon reaching each tier 
                  and are valid for one year from your last stay. Join automatically upon your first reservation!
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="border-primary/20">
              <CardHeader>
                <CardTitle className="text-xl">Important Terms & Conditions</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 text-sm text-muted-foreground">
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>All offers subject to availability and blackout dates may apply</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>Discounts cannot be combined unless specifically stated</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>Valid ID required for age-based or service-based discounts</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>Promotional rates exclude taxes and fees unless otherwise noted</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                    <span>Pine Ridge RV Resort reserves the right to modify or discontinue offers at any time</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="hero" size="lg" asChild>
              <Link to="/reservations">Book with Discount</Link>
            </Button>
