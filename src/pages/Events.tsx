  ...
  const upcomingEvents = [
    {
      ...
      description:
        "Live acoustic performances by local artists around the campfire amphitheater",
    ...
    },
    {
      ...
      description:
        "Games, activities, face painting, and prizes for the whole family",
      category: "Family",
      icon: Users,
      color: "bg-orange/10",
    ...
    },
    {
      ...
      description:
        "Gather around the campfire for stories, songs, and delicious s'mores",
      category: "Weekly",
      icon: Flame,
      color: "bg-accent/10",
    ...
    },
    {
      ...
      description:
        "Learn landscape photography techniques with our natural surroundings",
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm">
              ...
              <span>
                Weekly Events • Seasonal Celebrations • Special Activities
              </span>
            </div>
          </div>
        </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-12 h-12 rounded-lg flex items-center justify-center ${event.color} flex-shrink-0`}
                    >
      ...
      <section className="py-20 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              We offer a variety of activities to suit every interest and age
              group
            </p>
          </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          Some special events may require advance registration
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          Check the activity board at reception for daily
                          updates
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          Follow our social media for event photos and updates
                        </span>
                      </li>
                    </ul>
                  </div>
      ...
      <section className="py-20 bg-warm-gradient text-orange-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Join the Fun!</h2>
          <p className="text-xl mb-8 text-orange-foreground/90 max-w-2xl mx-auto">
            Reserve your spot and become part of our vibrant community of
            outdoor enthusiasts.
          </p>
