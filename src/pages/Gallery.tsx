  ...
  const featuredPhotos = [
    {
      ...
      category: 'Nature',
      description: 'Beautiful morning sunrise reflecting on the calm lake waters',
      location: 'Pine Lake',
      season: 'Summer'
    },
    {
      ...
      category: 'Sites',
      description: 'Spacious RV site with direct lake access and mountain views',
    ...
    },
    {
      ...
      category: 'Activities',
      description: 'Families enjoying our heated swimming pool and recreation area',
  ...
  const virtualTourAreas = [
    {
      ...
      icon: Waves,
      features: ['Interactive hotspots', 'Zoom capability', 'Full 360° rotation']
    },
    {
      name: 'Site Walkthrough',
      description: 'Virtual tour of our premium RV sites',
      icon: Home,
      features: ['Multiple site types', 'Amenity highlights', 'Size comparisons']
    },
    {
      name: 'Facility Tour',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8">
              Discover the beauty of Pine Ridge RV Resort through our photo collection
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {galleryCategories.map((category, index) => (
              <Card key={index} className="border-border hover:shadow-soft transition-shadow group">
                <CardHeader>
                  <div className={`w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 ${category.color} group-hover:scale-110 transition-transform`}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              We love featuring guest photos! Share your favorite Pine Ridge moments with us.
            </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Email your photos to gallery@pineridgerv.com</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>Original photos taken at Pine Ridge RV Resort</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
      ...
      <section className="py-20 bg-warm-gradient text-orange-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-orange-foreground/90 max-w-2xl mx-auto">
            Book your stay and start capturing beautiful moments at Pine Ridge RV Resort.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="hero" size="lg" asChild>
              <Link to="/reservations">Book Your Photo-Worthy Stay</Link>
            </Button>
            <Button variant="outline" size="lg" className="bg-white/10 border-white/30 text-white hover:bg-white/20" asChild>
              <Link to="/amenities">Explore Our Amenities</Link>
            </Button>
          </div>
        </div>
      </section>
