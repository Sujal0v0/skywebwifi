  ...
  const specialCircumstances = [
    {
      ...
      description:
        "Full refund for severe weather warnings issued by National Weather Service",
      icon: Shield,
      details: [
  ...
  const refundProcess = [
    {
      ...
      description:
        "Cancel online through your booking confirmation or call our office",
    },
    {
      step: "2",
      title: "Confirmation Email",
      description:
        "Receive cancellation confirmation with refund details within 24 hours",
    },
    {
      step: "3",
    ...
    },
    {
      ...
      description:
        "Allow additional 2-3 business days for funds to appear in your account",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {cancellationTiers.map((tier, index) => (
              <Card
                key={index}
                className={`border-2 ${tier.bgColor} border-current`}
              >
                <CardContent className="p-6 text-center">
                  <div
                    className={`w-16 h-16 rounded-full ${tier.bgColor} flex items-center justify-center mx-auto mb-4`}
                  >
                  ...
                  <div className={`text-2xl font-bold ${tier.color} mb-3`}>
                    {tier.refund}
                  </div>
          ...
          <div className="mt-12 text-center bg-muted/50 p-6 rounded-lg max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground">
              Cancellation time is based on your scheduled check-in time, not
              calendar days. Check-in is at 2:00 PM, so 48 hours before means
              2:00 PM two days prior.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mt-12 text-center">
            <Card className="max-w-2xl mx-auto border-orange/20">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Refunds are processed to the original payment method only. For
                  credit card payments, the refund will appear as a credit on
                  your statement. Cash payments require in-person pickup with
                  valid ID.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Our friendly staff is here to help with any questions about our
              cancellation policy
            </p>
