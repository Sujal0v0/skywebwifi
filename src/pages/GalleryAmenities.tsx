  ...
  const featuredAmenities = [
    {
      ...
      description:
        "Large heated pool with mountain views and comfortable pool deck seating",
    ...
    },
    {
      ...
      description:
        "Therapeutic hot tub with stunning sunset views and privacy landscaping",
      category: "Pool Complex",
      hours: "6:00 AM - 10:00 PM",
      season: "All Year",
      features: [
    ...
    },
    {
      ...
      description:
        "Convenient store with camping essentials, snacks, and local souvenirs",
      category: "Services",
    ...
    },
    {
      ...
      description:
        "Family-friendly game room with ping pong, pool table, and arcade games",
      category: "Recreation",
      hours: "6:00 AM - 11:00 PM",
      season: "All Year",
    ...
    },
    {
      ...
      description:
        "Clean, efficient laundry room with multiple washers, dryers, and folding space",
      category: "Facilities",
      hours: "24 Hours",
      season: "All Year",
      features: [
    ...
    },
    {
      ...
      description:
        "Spotless restroom facilities with private showers and family bathrooms",
      category: "Facilities",
      hours: "24 Hours",
      season: "All Year",
      features: [
    ...
    },
    {
      ...
      description:
        "Safe, modern playground equipment in a shaded area with safety surfacing",
      category: "Recreation",
      hours: "Dawn to Dusk",
      season: "All Year",
      features: [
  ...
  const amenityDetails = [
    {
      ...
      highlights: [
        "Heated to 82°F year-round",
        "Chemical-free hot tub option",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm">
              ...
              <span>
                35+ Amenity Photos • Modern Facilities • Premium Services
              </span>
            </div>
          </div>
        </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Pool & Hot Tub:</strong> 6:00 AM - 10:00 PM
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Recreation Center:</strong> 6:00 AM - 11:00 PM
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Camp Store:</strong> 8:00 AM - 8:00 PM
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span>
                          <strong>Office:</strong> 8:00 AM - 10:00 PM
                        </span>
                      </li>
                    </ul>
                  </div>
      ...
      <section className="py-20 bg-warm-gradient text-orange-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-orange-foreground/90 max-w-2xl mx-auto">
            Book your stay and enjoy all the comfort and convenience our
            facilities offer.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="hero" size="lg" asChild>
              <Link href="/reservations">Reserve Your Spot</Link>
            </Button>
            <Button
              variant="outline"
              size="lg"
              ...
              asChild
            >
              <Link href="/amenities">View Full Amenities List</Link>
            </Button>
          </div>
        </div>
      </section>
